          ...
          <table role="presentation" class="container" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr> 
              <td class="p-32"> 
                ...
                <p class="text"> 
                  We received a request to reset the password for your account associated with ${email}. Click the button below to reset your password. 
                </p> 
...
20px 0;"> 
                ...
                <p class="muted">This link will expire in <strong>15 minutes</strong>.</p> 
